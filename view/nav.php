<nav id="mainNav" class="Roboto bg-myBlue font-weight-bold ">
	<ul class="nav nav-pills justify-content-md-between justify-content-lg-around text-center align-items-center">
		...
		<li class="nav-item"> 
			...
			<a <?php echo $aboutON?> class="nav-link" href="index.php?page=about" role="button" aria-haspopup="true" aria-expanded="false" href="index.php?page=about">QUI SUIS-JE ?</a>
