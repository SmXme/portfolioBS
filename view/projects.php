    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p>J'ai développé de A à Z cette application, m'appuyant sur un plugin DeathMatch CSGO lors d'un stage d'une durée d'un mois.</p>
          ...
          <a href="http://rankcsgofr.smxme.fr" target="_blank" class="btn btn-primary btn-disabled">Visiter</a>
      </div>
    </div>
</div>
...
<div class="col-xs-12 mt-4 mt-md-0 mb-4 mb-md-0 col-md-3 d-flex justify-content-center">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="https://sendwish.smxme.fr" target="_blank" class="btn btn-primary">Visiter</a>
      </div>
    </div>
  </div>
    ...
    <div class="col-xs-12 mt-4 mt-md-0 col-md-3 d-flex justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="card-title">Zimoule.fr</h4>
                <p class="card-text">Site vitrine et interactif pour le streamer / vidéaste Zimoule</p>
                <p class="card-text">Réalisation du projet de A à Z.</p>
                <p class="card-text">Utilisation API Twitch et API Steam pour les dernières vidéos / diffusions.</p>
                <p class="card-text">Système custom de fidélité et d'exp avec classements par points.</p>
