...
<div class="card" style="width: 20rem;">
  <img class="card-img-top" src="images/screenshotGestemps.png" alt="Screenshot de l'application Gestemps">
  <div class="card-body">
...
<div class="card" style="width: 20rem;">
  <img class="card-img-top" src="images/screenshotRankMe.png" alt="Screenshot de l'application RankMeAPP">
  <div class="card-body">
